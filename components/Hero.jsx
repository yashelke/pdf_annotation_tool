...
export default function Hero() {
  return (
    <section id="hero" className="bg-red-300 text-center py-20 px-6 md:px-10">
      ...
      <a
        href="/editor"
        className="inline-block bg-blue-600 text-white font-semibold text-sm md:text-base py-3 px-6 md:px-8 rounded-xl shadow-md hover:bg-blue-700 hover:shadow-lg transition-all duration-300 ease-in-out focus:outline-none focus:ring-2 focus:ring-blue-400 focus:ring-offset-2"
      >
        Try the Editor
      </a>
    </section>
