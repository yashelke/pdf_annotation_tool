export default function Features() {
  const features = [
    {
      ...
      desc: "Easily highlight important parts of your PDF.",
    },
    { title: "Add Comments", desc: "Attach notes anywhere on your document." },
    {
      title: "Draw Shapes",
      desc: "Draw arrows, boxes, and more directly on the PDF.",
    },
    {
      title: "Download Annotations",
      desc: "Export the annotated file instantly.",
    },
  ];
  ...
  return (
    <section
      id="features"
      className="py-16 bg-white text-center px-4 sm:px-6 md:px-10"
    >
      ...
      <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-4">
        {features.map((feat, index) => (
          ...
          >
            ...
            <p className="text-black text-sm md:text-base">{feat.desc}</p>
          </div>
        ))}
      </div>
    </section>
