export default function CallToAction() {
  return (
    <section id="cta" className="bg-blue-100 py-20 text-center px-6 md:px-10">
      <h2 className="text-2xl text-black md:text-3xl font-semibold mb-4">
        Start Annotating Now
      </h2>
      <p className="mb-6 text-black max-w-xl mx-auto text-sm md:text-base">
      ...
      <div className="flex justify-center items-center gap-4 flex-wrap">
        <input
          ...
          className="border rounded px-3 py-2 bg-white shadow-sm text-black"
          disabled
        />
